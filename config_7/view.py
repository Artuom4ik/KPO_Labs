...
class CalculatorView:
    ...
    def create_ui(self):
        ...
        # Calculate button dimensions (scale with window size)
    ...
    def update_config(self, config):
        """Update view with new configuration settings."""
        print("View: Updating configuration")
        self.config = config
        
        # Update font and colors for all elements
        ...
        print(f"View: Font family={font_family}, size={font_size}, button_size={button_font_size}")
        print(f"View: Button color={button_color}, hover={button_hover_color}, text={text_color}")
        ...
        print(f"View: Button dimensions: {button_width}x{button_height}")
        
        try:
            # Update display
            print("View: Updating display")
            self.display.configure(
                font=(font_family, font_size),
                text_color=text_color
            )
            
            # Update equation mode checkbox
            print("View: Updating equation mode checkbox")
            ...
            # Update clear button
            print("View: Updating clear button")
            ...
            print("View: Forcing UI update")
            self.root.update_idletasks()
            print("View: Configuration update complete")
        except Exception as e:
            print(f"View: Error updating configuration: {str(e)}")
            import traceback
            traceback.print_exc() 